...
function OnGetResultadoCalculoPrueba(resultado) {
    ...
    //document.getElementById('DVDatosTePareceSuficiente').style.display = "block";
    //document.getElementById('DVResultadoPMT_2').style.display = "block";
    //alert(resultado);
    ...
    var iPorcientoPMG = (PMGIND / pSalarioBaseCotizacionMensual) * 100;
    ...
    if (listaResultadoN1[0] != "NP") {
        ...
        if (listaResultadoN1.length != 2) {
            ...
            if (listaResultadoN1[2] == "0") {
                ...
                //document.getElementById('DVGraficaContenedor').style.display = "none";
                ...
                //document.getElementById('DVDatosTePareceSuficiente').style.display = "none";
                //document.getElementById('DVResultadoPMT_2').style.display = "none";
                ...
                //document.getElementById("lblPMG").style.display = "none";
                ...
                if (parseFloat(TRmax) > 100) {
                    ...
                    $("#DVDatosTePareceSuficiente").removeClass("panelOculto").addClass("panelVisible");
                    $("#DVResultadoPMT_2").removeClass("panelOculto").addClass("panelVisible");
                    //document.getElementById('DVGraficaContenedor').style.display = "inline";
                    //document.getElementById('DVDatosTePareceSuficiente').style.display = "inline";
                    //document.getElementById('DVResultadoPMT_2').style.display = "inline";
            ...
            //alert(listaResultadoN1[1]);
            $('#lMensajeError').text(listaResultadoN1[1]);
            //document.getElementById('lMensajeError').innerText = listaResultadoN1[1];
            $("#aMensajeError").click();
        ...
        encabezadoTabla += "<tr><td colspan='5' class='RegistrostablaNP' style='padding-top: 0px; padding-bottom: 0px;'><img src='imagenes/encabezado_mejora_NP.png' ></td></tr>";
